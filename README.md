...
| Nova identity | Nova gets a **persona layer**: her name, a personality (concise / professional / warm / playful), and your name — set by voice ("call me Alex", "be more concise", "forget that I like mornings", "what do you know about me", "good morning nova") or in the new Identity side panel with a personality picker. Personal facts live in a local user model with key-based dedupe (last-wins, 100-fact cap, forget restores via undo/5 s toast); the personality tints greetings and acknowledgements while factual wording stays unchanged — L1 SAFE read, L2 REVERSIBLE forget, the #1 feature gap between Nova and the top-ranked personal AI assistants of 2026 |
